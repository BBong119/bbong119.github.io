...
## Enumerations
- [`AccompanyingTextRecognitionMode`]({{ site.manual_interface_argument}}AccompanyingTextRecognitionMode.html)	
- [`BarcodeColourMode`]({{ site.manual_interface_argument}}BarcodeColourMode.html)	
- [`BarcodeComplementMode`]({{ site.manual_interface_argument}}BarcodeComplementMode.html)	
- [`BarcodeFormat`]({{ site.manual_interface_argument}}BarcodeFormat.html)	
- [`BarcodeFormat_2`]({{ site.manual_interface_argument}}BarcodeFormat_2.html)	
- [`BinarizationMode`]({{ site.manual_interface_argument}}BinarizationMode.html)	
- [`ColourClusteringMode`]({{ site.manual_interface_argument}}ColourClusteringMode.html)	
- [`ColourConversionMode`]({{ site.manual_interface_argument}}ColourConversionMode.html)	
- [`ConflictMode`]({{ site.manual_interface_argument}}ConflictMode.html)	
- [`DeformationResistingMode`]({{ site.manual_interface_argument}}DeformationResistingMode.html)	
- [`DPMCodeReadingMode`]({{ site.manual_interface_argument}}DPMCodeReadingMode.html)	
- [`GrayscaleTransformationMode`]({{ site.manual_interface_argument}}GrayscaleTransformationMode.html)	
- [`ImagePixelFormat`]({{ site.manual_interface_argument}}ImagePixelFormat.html)	
- [`ImagePreprocessingMode`]({{ site.manual_interface_argument}}ImagePreprocessingMode.html)	
- [`IMResultDataType`]({{ site.manual_interface_argument}}IMResultDataType.html)	
- [`IntermediateResultSavingMode`]({{ site.manual_interface_argument}}IntermediateResultSavingMode.html)	
- [`IntermediateResultType`]({{ site.manual_interface_argument}}IntermediateResultType.html)	
- [`LocalizationMode`]({{ site.manual_interface_argument}}LocalizationMode.html)	
- [`QRCodeErrorCorrectionLevel`]({{ site.manual_interface_argument}}QRCodeErrorCorrectionLevel.html)	
- [`RegionPredetectionMode`]({{ site.manual_interface_argument}}RegionPredetectionMode.html)	
- [`ResultCoordinateType`]({{ site.manual_interface_argument}}ResultCoordinateTypehtml)	
- [`ResultType`]({{ site.manual_interface_argument}}ResultType.html)	
- [`ScaleUpMode`]({{ site.manual_interface_argument}}ScaleUpMode.html)	
- [`TerminatePhase`]({{ site.manual_interface_argument}}TerminatePhase.html)	
- [`TextAssistedCorrectionMode`]({{ site.manual_interface_argument}}TextAssistedCorrectionMode.html)	
- [`TextFilterMode`]({{ site.manual_interface_argument}}TextFilterMode.html)	
- [`TextResultOrderMode`]({{ site.manual_interface_argument}}TextResultOrderMode.html)	
- [`TextureDetectionMode`]({{ site.manual_interface_argument}}TextureDetectionMode.html)	
